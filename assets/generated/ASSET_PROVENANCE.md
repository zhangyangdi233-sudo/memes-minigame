...
The game keeps three composition-defining raster assets as curated OpenAI imagegen outputs. They are loaded directly at runtime and are not recreated by the procedural fallback generator.
...
All three images use the established five-color International Style direction: deep green, ink black, warm cream, yellow green, and fluorescent pollution green. Their subjects combine an empty road, telecommunications towers, analog signal noise, a detached classmate, and editorial poster grids.
